...
function extractKeywords(text: string): string[] {
  ...
  const patterns = [
    ...
    /티월드|T world|앱|어플/g,
    // 주소 관련
    /주소|이사|이전|청구지|배송지|우편번호|도로명|지번/g,
  ];
...
function generateSummary(text: string, keyword: string): string {
  const summaries: Record<string, string> = {
    ...
    '주소': '주소 변경 관련 문의입니다. 청구지 주소 변경 방법, 도로명주소 검증, 인터넷/TV 이전 설치 절차를 안내해 주세요.',
    '이사': '이사로 인한 주소 변경 관련 문의입니다. 청구지 주소 변경 및 인터넷 이전 설치에 대해 안내해 주세요.',
    '이전': '주소 이전 및 인터넷/TV 이전 설치에 관한 문의입니다. 이전 절차와 비용, 소요 기간을 안내해 주세요.',
    '청구지': '청구지 주소 변경 관련 문의입니다. T월드 앱 또는 114 전화로 변경 가능함을 안내해 주세요.',
...
function generateScript(keyword: string): string {
  const scripts: Record<string, string> = {
    ...
    '주소': '고객님, 주소 변경에 대해 안내 드리겠습니다. 새로운 주소를 말씀해 주시면 도로명주소를 검증하여 정확하게 등록해 드리겠습니다.',
    '이사': '고객님, 이사 축하드립니다! 청구지 주소 변경을 도와드리겠습니다. 새로 이사 가신 주소를 말씀해 주시겠어요?',
    '이전': '고객님, 주소 이전에 대해 안내 드리겠습니다. 인터넷이나 TV 서비스도 함께 이용 중이시면 이전 설치 절차도 안내해 드리겠습니다.',
    '청구지': '고객님, 청구지 주소 변경은 T월드 앱 또는 114 전화로 즉시 가능합니다. 어떤 방법으로 진행하시겠어요?',
